...
import Categories from "../pages/admin/AdminCategorie";
import CategorieForm from "../pages/admin/ajoutCategorie";
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path={"/dashboard/categories/nouvelle"} element={<CategorieForm/>} />
      <Route path={"/dashboard/categories/:id/modifier"} element={<CategorieForm/>} />
